...
V7: entities — .astro markup uses HTML entities (&mdash;, &middot;, &minus;, &rarr;, &larr;, &rsquo;, &times;) and no literal em-dash in .astro; blog markdown em-dashes are space-padded, and both literal "—" and &mdash; are in use.
